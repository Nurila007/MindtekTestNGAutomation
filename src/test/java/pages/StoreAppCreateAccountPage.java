...
public class StoreAppCreateAccountPage {
    ...
    @FindBy(xpath="//select[@id='days']/option[6]")
    public WebElement daysBoxOption;

    @FindBy(xpath="//select[@id='months']/option[6]")
    public WebElement monthsBoxOption;

    @FindBy(xpath="//select[@id='years']/option[6]")
    public WebElement yearsBoxOption;
